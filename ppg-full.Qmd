...
Notes about the classification: circumscription and synonymy are not shown; this information can be found on the digital version of the classification at <https://pteridogroup.github.io>.
...
ppg_supp_data_no_na <- ppg_supp_data |>
...
indents <-
  ...
  as_tibble() |>
  select(taxonID = TaxonConceptID, indent = indent)
...
ppg_tl |>
  ...
  mutate(
    ...
    pretty = glue(
      "{taxonRank_print} {name_print}　{scientificNameAuthorship}, {namePublishedIn}. {taxon_count}."
    ) |>
      as.character() |>
      str_replace_all("\\.+", ".") |>
      str_squish(),
